    ...
    '3v3': {
      ...
      list: [
        ...
        { id: 'rmp', name: 'RMP', members: ['rogue', 'mage', 'priest'],
          make: '贼 + 法师 + 神牧 / 戒律牧', one: '竞技场最老牌的 setup 组合。',
          page: 'rmp-3v3.html', st: [2, 2, 2, 1, 2, 2] },
        { id: 'rmd', name: 'RMD', members: ['rogue', 'mage', 'druid'],
          make: '贼 + 法师 + 恢复德', one: '先把治疗预付在场上，再让恢复德加入控制链。',
          page: 'rmd.html', st: [2, 2, 2, 1, 2, 2] },
        { id: 'rps', name: 'RPS', members: ['rogue', 'priest', 'shaman'],
          make: '贼 + 暗牧 + 恢复萨', one: '暗牧让全场欠血，贼收最先露头的那一条。',
          page: 'rps.html', st: [2, 2, 2, 1, 2, 2] },
        { id: 'rls', name: 'RLS', members: ['rogue', 'warlock', 'shaman'],
          make: '贼 + 痛苦术 + 恢复萨', one: '术士记慢账，贼用短窗收账。',
        ...
        { id: 'cupid', name: 'Cupid', members: ['priest', 'paladin', 'hunter'], verified: '12.1',
          make: '戒律牧 + 惩戒骑 + 射击猎', one: '陷阱拿走治疗，制裁钉住目标，恐惧接完整条控制链。',
          page: 'cupid.html', st: [2, 2, 2, 1, 2, 2] },
