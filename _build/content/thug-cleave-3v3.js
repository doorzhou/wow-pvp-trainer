...
module.exports = {
 "meta": {
  "title": "Thug Cleave 贼+牧+猎 3v3 组合训练器 · 魔兽世界 12.0.7",
  ...
  "footer": "Patch 12.0.7 · Midnight 赛季一。图标与中文技能名来自 <a href=\"https://www.wowhead.com\" target=\"_blank\">Wowhead</a> 官方数据接口（逐个实测）。\n  组合定位 <a href=\"https://www.icy-veins.com/wow/subtlety-rogue-pvp-best-arena-compositions\" target=\"_blank\">Icy Veins（Thug Cleave）</a> ·\n  天赋数据 <a href=\"https://murlok.io/rogue/subtlety/3v3\" target=\"_blank\">Murlok.io</a>。训练记录只存在这台浏览器里。<br><a href=\"index.html\">← 返回全部训练器</a> · <a href=\"index.html#legal\">数据来源与免责声明</a>",
  "jsonld": null
 },
 "nav": [
  {
 ...
 "sections": {
  ...
  "s7": "<div class=\"wrap\">\n  <p class=\"lead\">上场前一人扫一栏。<strong>三个人都看一遍另外两栏</strong>——3v3 的失败几乎都来自\"不知道队友在想什么\"。</p>\n  <div class=\"sheet\" id=\"sheet\"></div>\n</div>"
 },
 "fragments": {
