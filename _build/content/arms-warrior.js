...
<h2>开赛前先问自己三句</h2>
<div class="rows">
  <div class="row"><div class="h" onclick="tg(this)"><span class="t">对面谁有免疫牌？</span><span class="sub">决定<sk>碎裂投掷</sk>留给谁</span><span class="ar">▸</span></div><div class="b"><p>圣盾术、<sk>寒冰屏障</sk>、<sk>暗影斗篷</sk>——<sk>碎裂投掷</sk> 3 分钟冷却，一局大概只有一次机会用对。<b>开打前就该定好它是留给谁的。</b></p></div></div>
  ...
  match: {
    ...
    list: [
      ...
      },
      {
        ...
        q: [
          ['<sk>圣盾术</sk> —— 全场最硬的一张', '完全免疫。<b>这是<sk>碎裂投掷</sk>唯一该留给的目标</b>——3 分钟冷却换掉他的免疫，是这个对局最大的一笔交易。'],
          ...
          ['留着<sk>碎裂投掷</sk>', '开场别急着交。<b>等他把圣盾术交出来之前，你的伤害都是在逼牌</b>；真正的击杀窗口在免疫被撕之后。'],
        ],
      },
      {
      ...
      },
      {
        ...
        q: [
          ['<sk>寒冰屏障</sk> —— 完全免疫', '免疫一切并解除控制。<b><sk>碎裂投掷</sk>的第二个理想目标</b>；撕不掉的话，等它自己结束再开窗口。'],
