...
module.exports = {
  "meta": {
    "title": "贼牧 2v2 组合训练 · " + PATCH + " Midnight",
    "desc": "魔兽世界 " + PATCH + " 头号 2v2 组合「贼 + 戒律牧」双视角配合训练。2v2 赢在两个人的伤害叠在一起——含击杀链、防守链、双人决策器与 40 道分视角判断题。",
    "keywords": "2v2,贼牧,组合,竞技场,魔兽世界," + PATCH + ",配合,arena 2v2",
    "h1": "<span class=\"r\">贼</span> + <span class=\"p\">戒律牧</span> · 2v2 组合训练器",
    "footer": "Patch " + PATCH + " · Midnight 赛季一。技能名与图标： <a href=\"https://www.wowhead.com\" target=\"_blank\">Wowhead</a> 官方数据接口。组合定位 与天赋数据 <a href=\"https://www.icy-veins.com/wow/discipline-priest-pvp-best-arena-compositions\" target=\"_blank\">Icy Veins</a> · <a href=\"https://murlok.io/priest/discipline/2v2\" target=\"_blank\">Murlok.io 戒律牧 2v2</a> · <a href=\"https://murlok.io/rogue/subtlety/2v2\" target=\"_blank\">Murlok.io 敏锐贼 2v2</a>。<br><a href=\"index.html\">← 返回全部训练器</a> · <a href=\"index.html#legal\">数据来源与免责声明</a>",
    "jsonld": null
  },
  "nav": [
    {
  ...
  "sections": {
    ...
    "s6": "<div class=\"wrap\">\n  <p class=\"lead\">一人一栏。两个人都看一遍对方那栏。</p>\n  <div class=\"sheet\" id=\"sheet\"></div>\n</div>"
  },
  "fragments": {
  ...
  "quiz": [
    {
      ...
      "e": [
        ...
        "<sk>嫁祸诀窍</sk> 转移的是威胁值，在 PvP 里对玩家的攻击目标影响有限——<b>它不能替代真正的控制或隔断。</b>"
      ],
