...
const PAGES = [
  ...
  {
    file: 'resto-druid', kind: 'spec', cls: 'druid', spec: 'restoration',
    h1: '恢复德 PvP 判断训练器', short: '恢复德',
    icon: 'spell_nature_healingtouch', tier: null, color: '#FF7C0A',
    crumb: ['德鲁伊', '恢复'], store: 'banyeRestoDruidPvP1207', quizSec: 's4',
    catLabel: { general: '通用手法' },
    done: {
      hi: '你已经在挨打之前铺，不是在追血条。',
      mid: '基础判断成立，把错题再过一轮。',
      lo: '先回骨架页把「持续治疗是预付款」那一条过一遍。',
    },
    talent: {
      rows: [
        { lb: '英雄天赋', vv: '<b>林地守护者 Keeper Of The Grove</b>（44/50）—— Wildstalker 只有 6 人。' },
        {
          lb: 'PvP 天赋 · 三格全定死',
          vv: '<b>Call of Ohn\'ahra</b>（49/50）—— <sk>自然迅捷</sk>也影响<sk>旋风</sk>，冷却延长 10 秒<br>' +
            '<b>Forest Guardian</b>（49/50）—— 伤害与连击技能延长你的持续治疗<br>' +
            '<b>Early Spring</b>（49/50）—— <sk>野性成长</sk>变瞬发<br>' +
            '<span class="dimtx">其余 8 个 PvP 天赋加起来只有 <b>3 人次</b>。' +
            '<b>本站已上线的专精里，这是唯一一个三格全无取舍的。</b></span>'
        },
      ],
      note: '上述 PvP 天赋暂无官方简体中文名，使用英文原名。' +
        '英雄天赋里另有一个同名的 Early Spring（缩短<sk>迅捷治愈</sk>与<sk>野性成长</sk>冷却 1 秒），与 PvP 天赋那一格不是一回事。' +
        '天赋导入串待补充。',
      tree: {
        survey: '职业树 52 格 + 专精树 46 格 + 英雄天赋 28 格，共 <b>126 格</b>。' +
          '扣掉只有 6 人走的 Wildstalker 整条线、以及 Keeper Of The Grove 线里跟着「走这条线」一起点掉的 12 格，' +
          'top50 的实测里 <b>82 格是定死的</b>，真正需要判断的是 <b>18 格</b>，下面是其中 7 格。' +
          '<b>这 18 格里有一半管的是控制与位移，不是治疗</b>——' +
          '恢复德的配点分歧主要发生在「怎么活下来」，不在「怎么治得更多」。',
        picks: [
          {
            n: 'Typhoon', tree: '职业', u: 39,
            b: '向前方投出台风，击退目标并减速。' +
              '<br><b>分歧格里使用率最高的一个，而它是纯防守工具。</b>' +
              '把贴脸的近战推开一次，省下的治疗量比多按几次治疗键多——' +
              '<b>对面近战越多，这一格越接近必点。</b>'
          },
          {
            n: 'Improved Ironbark', tree: '专精', u: 38,
            b: '<sk>铁木树皮</sk>冷却缩短 20 秒。' +
              '<br><b>它买的是「这一局能用几次」。</b>对面伤害是一波一波的（惩戒骑、法师），' +
              '多一次减伤就多接住一个杀窗；对面是持续压制型（暗牧、术士），这一点的边际价值下降。'
          },
          {
            n: 'Improved Swiftmend', tree: '专精', u: 38,
            b: '<sk>迅捷治愈</sk>治疗量提高 30%。' +
              '<br>纯数值，不看对面。<b><sk>迅捷治愈</sk>是恢复德唯一的即时大治疗</b>，' +
              '所以这一格的实际收益比看起来稳定——代价是它没有解决「被控住时什么都做不了」那个问题。'
          },
          {
            n: 'Innervate', tree: '职业', u: 36,
            b: '为一名治疗者恢复法力。' +
              '<br><b>36/50 说明它不是无脑必点。</b>恢复德打不完的局多半是没法力，' +
              '但如果你的局普遍打得短、或队里另有续航来源，这一点换成生存或控制更实在。' +
              '<b>判据是你上一局有没有真的把法力打空。</b>'
          },
          {
            n: 'Ursol\'s Vortex', tree: '职业', u: 34,
            b: '在指定位置制造旋风，减速范围内敌人，敌人第一次想离开时会被拉回中心。' +
              '<br><b>又一个纯防守格。</b>它不是控制链的一环，是<b>改写地形</b>——' +
              '放在你和追你的人之间，逼他绕路。对机动性高的对手（DH、武僧）价值最高。'
          },
          {
            n: 'Tranquility', tree: '专精', u: 33,
            b: '引导数秒，治疗范围内所有盟友。' +
              '<br><b>这一格值得单独看：一个大招级的群体治疗，竞技场里有 17 个人不点。</b>' +
              '原因是它要站定引导——<b>而恢复德被贴脸时最缺的就是「能站定」这个前提</b>。' +
              '你的局如果经常被两个近战咬住，这一点很可能放不出来。'
          },
          {
            n: 'Incapacitating Roar', tree: '职业', u: 31,
            b: '变熊咆哮，使 10 码内敌人瘫痪 3 秒，伤害会解除。' +
              '<br><b>你能自己解围的少数几张牌之一</b>，而且是范围的。' +
              '3 秒不长，但对恢复德来说「换出一次位移的时间」就够了。' +
              '<b>对面近战多、你的队友剥离能力弱时，这一格的价值直接翻倍。</b>'
          },
        ],
        src: '使用率：Murlok.io · ' + PATCH + ' 赛季一 · 美/欧/韩/台四区 <b>3v3 恢复德 top 50</b> 实测配点。' +
          '「什么时候点」为编者按天赋效果与该专精打法推导，非实测结论。' +
          '暂无官方简体中文名的天赋使用英文原名。',
      },
    },
    gear: {
      ...
      statRead: '<b>精通领先，全能跟上，爆击几乎为零。</b>' +
        '精通「和谐」按目标身上你的持续治疗数量提高治疗量——<b>属性面板和打法是同一句话：把持续治疗铺厚。</b>' +
        '<b>爆击接近于零这一点值得单独看</b>：它说明恢复德不指望某一次治疗打出高数字，' +
        '它指望的是「一直有东西在跳」。',
      statSrc: '数据：Murlok.io · ' + PATCH + ' 赛季一 · 美/欧/韩/台四区 <b>3v3 恢复德 top 50</b> 实测配装。' +
        '档位划分为编者按断层位置判定。',
    },
  },
  {
  ...
  {
    file: 'havoc-dh', kind: 'spec', cls: 'demonhunter', spec: 'havoc',
    h1: '浩劫 DH PvP 判断训练器', short: '浩劫 DH',
    icon: 'ability_demonhunter_specdps', tier: 'A', color: '#A330C9',
    crumb: ['恶魔猎手', '浩劫'], store: 'banyeHavocDHPvP1207', quizSec: 's4',
    catLabel: { general: '通用手法' },
    done: {
      hi: '你已经在算「冲进去怎么出来」，不是看到人就冲。',
      mid: '基础判断成立，把错题再过一轮。',
      lo: '先回骨架页把「该不该冲」的四条件过一遍。',
    },
    talent: {
      rows: [
        { lb: '英雄天赋', vv: '<b>奥达奇掠夺者 Aldrachi Reaver</b>（50/50）—— 邪能灼痕 0 人。' +
          '围绕 Reaver\'s Glaive 的强化循环展开，<b>给浩劫加了一层「按顺序打」的要求</b>。' },
        { lb: 'PvP 天赋 · 两格接近必带', vv: '<b>Blood Moon</b>（50/50）—— Consume Magic 变成范围驱散并生成灵魂碎片<br>' +
          '<b>Glimpse</b>（49/50）—— <sk>复仇回避</sk>提供失控免疫并在落地前减伤，' +
          '<b>把一个位移技能变成了保命技能</b>' },
        {
          lb: 'PvP 天赋 · 第三格',
          vv: '<b>Reverse Magic</b>（30/50）—— 移除全队有害魔法效果并反弹给施法者<br>' +
            '<b>Detainment</b>（20/50）—— <sk>禁锢</sk>延长 1 秒，且目标免疫伤害和治疗<br>' +
            '<span class="dimtx">Detainment 值得注意：<b>它把禁锢从「控住打」变成「移出战斗」</b>，' +
            '跟德鲁伊的<sk>旋风</sk>是同一类效果，用来摘掉对面治疗。</span>'
        },
      ],
      note: '上述 PvP 天赋暂无官方简体中文名，使用英文原名。',
      imp: {
        str: 'CEkAp/epaxe7D0A403L+Tvk0iaGMzMjZMmZMzMZYGAAAAAAwsYMbjZmZmtZmxyMzDMjlBzMbzsMzysMzMzy2sMNNjZGzYBAAAAAABYmZmBDABAAG',
        who: 'Zizzydh', where: 'US · Sargeras', rating: '3v3 3144', at: '2026-08-14',
        note: '这是<b>一个人的配点</b>，不是 top50 的平均——平均配点没有对应的串。' +
          '选它的理由是：<b>它在下面 6 个分歧格上与多数派全部一致</b>，' +
          'PvP 天赋和英雄天赋也都取的多数派。' +
          '<b>浩劫只有 6 个分歧格，是站上最少的</b>——所以这串基本等同于 top50 的公版。' +
          '真正要练的不是配点，是进出的时机。',
      },
      tree: {
        survey: '职业树 42 格 + 专精树 39 格 + 英雄天赋 28 格，共 <b>109 格</b>。' +
          '扣掉几乎没人走的邪能灼痕整条线，top50 的实测里 <b>103 格是定死的</b>。' +
          '<b>真正需要判断的只有 6 格 —— 站上分歧最少的专精</b>。' +
          '但分歧少不等于好玩：<b>浩劫的难点全在操作层</b>——什么时候冲、冷却按什么顺序、' +
          '引导什么时候安全。配点给不了你这些。',
        picks: [
          {
            n: 'Pitch Black', tree: '职业', u: 40, ch: 1,
            b: '<sk>黑暗</sk>的冷却时间大幅降低。' +
              '<br><b>这是二选一格，80% 选了它。</b><sk>黑暗</sk>给范围内所有人闪避几率——' +
              '这个使用率说明 top50 认为「给队伍一个躲伤害的窗口」值得为它花一格。' +
              '注意它是<b>概率闪避不是稳定减伤</b>，面对集中爆发时价值最高。'
          },
          {
            n: 'Blind Fury', tree: '专精', u: 39,
            b: '<sk>眼棱</sk>每秒生成大量怒气，持续时间和伤害都提高。' +
              '<br><b>它把<sk>眼棱</sk>变成了你的主要怒气来源。</b>' +
              '但代价是<b>引导时间更长</b>——而引导期间你不能移动，这跟浩劫「一直在动」的直觉相反。' +
              '分歧就在这里：更多怒气 vs 更长的站定时间。'
          },
          {
            n: 'Felfire Haste', tree: '职业', u: 38,
            b: '<sk>邪能冲撞</sk>提高你的移动速度，持续一段时间。' +
              '<br>纯机动性加成。<b>浩劫的机动性已经是全场顶级，这一格是锦上添花</b>——' +
              '76% 的使用率说明多数人认为「更快」仍然值一格。'
          },
          {
            n: 'Shattered Restoration', tree: '职业', u: 30,
            b: 'Shattered Souls 的治疗效果提高。' +
              '<br><b>正好对半分。</b>浩劫的回血靠捡灵魂碎片，这一格加的是那部分。' +
              '分歧在于：<b>被集火时你更该做的是撤出去，不是站在原地多回一点</b>。'
          },
          {
            n: 'Felbound', tree: '职业', u: 19,
            b: '移动速度提高。' +
              '<br>又一个机动性格。<b>只有 38% 选它</b>——注意它和 Felfire Haste 的差距：' +
              '前者是常驻小加成，后者绑在你本来就要用的技能上。<b>绑在技能上的那个更值。</b>'
          },
          {
            n: 'Disrupting Fury', tree: '职业', u: 13,
            b: '<sk>瓦解</sk>成功打断时生成怒气。' +
              '<br><b>只有 26%——站上最低的一格。</b>它的价值完全取决于你打断的频率：' +
              '<b>打断得多就白赚资源，打不到就是空格</b>。这也说明多数人不把打断当常规输出手段。'
          },
        ],
        src: '使用率：Murlok.io · ' + PATCH + ' 赛季一 · 美/欧/韩/台四区 <b>3v3 浩劫 DH top 50</b> 实测配点。' +
          '「什么时候点」为编者按天赋效果与该专精打法推导，非实测结论。' +
          '暂无官方简体中文名的天赋使用英文原名。',
      },
    },
    gear: {
      ...
      statRead: '<b>精通和全能一组，急速在半山腰，爆击几乎是 0。</b>' +
        '精通对浩劫有额外意义：<b>Pursuit 让精通同时提高你的移动速度</b>——' +
        '也就是说堆精通既加伤害也加机动性，而机动性正是这个专精的强度来源。',
      statSrc: '数据：Murlok.io · ' + PATCH + ' 赛季一 · 美/欧/韩/台四区 <b>3v3 浩劫 DH top 50</b> 实测配装。' +
        '档位划分为编者按断层位置判定。',
    },
  },
  {
  ...
  {
    file: 'rps', kind: 'comp', h1: 'RPS · 贼 + 暗牧 + 恢复萨 3v3', short: 'RPS',
    icon: 'classicon_rogue', icon2: 'classicon_priest', icon3: 'classicon_shaman', tier: null, color: '#7a6fd4',
    crumb: ['组合', '3v3 RPS'], store: 'banyeRPS3v3_121', quizSec: 's5',
    views: [{ k: 'rogue', label: '🗡 贼' }, { k: 'priest', label: '☾ 暗牧' }, { k: 'shaman', label: '✚ 恢复萨' }],
    v2c: { rogue: 'r', priest: 'p', shaman: 'h' },
    members: [{ k:'r', cls:'R', label:'贼', icon:'classicon_rogue' }, { k:'p', cls:'P', label:'暗牧', icon:'classicon_priest' }, { k:'h', cls:'H', label:'恢复萨', icon:'classicon_shaman' }],
    catLabel: { r:'🗡 贼', p:'☾ 暗牧', h:'✚ 恢复萨', b:'⚔ 全队' }, tagCls: { r:'r', p:'p', h:'h', b:'' },
    done: { hi:'你们已经在用多线债务选择结算目标。', mid:'基础配合成立，把错题再过一轮。', lo:'先回骨架页把「谁先露头就收谁」过一遍。' },
    talent: { rows: [{ lb:'三人的天赋定盘', todo:1 }] },
    gear: { referNote:'<b>属性跟着专精走。</b>组合层面没有额外副属性取舍。', refer:[
      { n:'敏锐贼', ic:'classicon_rogue', page:'subtlety-rogue.html' },
      { n:'暗影牧师', ic:'classicon_priest', page:'shadow-priest.html' },
      { n:'恢复萨', ic:'classicon_shaman', page:'resto-shaman.html' },
    ] },
  },
  {
    file: 'rls', kind: 'comp', h1: 'RLS · 贼 + 痛苦术 + 恢复萨 3v3', short: 'RLS',
    icon: 'classicon_rogue', icon2: 'classicon_warlock', icon3: 'classicon_shaman', tier: null, color: '#8788EE',
    crumb: ['组合', '3v3 RLS'], store: 'banyeRLS3v3_121', quizSec: 's5',
    views: [{ k:'rogue', label:'🗡 贼' }, { k:'warlock', label:'♜ 痛苦术' }, { k:'shaman', label:'✚ 恢复萨' }],
    v2c: { rogue:'r', warlock:'w', shaman:'h' },
    members: [{ k:'r', cls:'R', label:'贼', icon:'classicon_rogue' }, { k:'w', cls:'M', label:'痛苦术', icon:'classicon_warlock' }, { k:'h', cls:'H', label:'恢复萨', icon:'classicon_shaman' }],
    catLabel: { r:'🗡 贼', w:'♜ 痛苦术', h:'✚ 恢复萨', b:'⚔ 全队' }, tagCls: { r:'r', w:'m', h:'h', b:'' },
    done: { hi:'你们已经在让慢账与快刀各走自己的时钟。', mid:'基础配合成立，把错题再过一轮。', lo:'先回骨架页把「先记账，再收账」过一遍。' },
    talent: { rows: [{ lb:'三人的天赋定盘', todo:1 }] },
    gear: { referNote:'<b>属性跟着专精走。</b>组合层面没有额外副属性取舍。', refer:[
      { n:'敏锐贼', ic:'classicon_rogue', page:'subtlety-rogue.html' },
